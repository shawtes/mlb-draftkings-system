...
class FantasyBaseballApp(QMainWindow):
    ...
    def update_probability_display(self, prob_summary, status):
        ...
        # Placeholder for actual GUI update logic
            ...
            for teams, stack_sizes, lineups_count in selected_combinations:
                ...
                try:
                    ...
                    worker = OptimizationWorker(
                        ...
                        min_unique=self.get_min_unique_constraint(),  # Use GUI value instead of hardcoded 3
                        bankroll=1000,
    ...
    def update_library_status(self):
        ...
        try:
            ...
            status_text += "❌ Copulas: Missing - pip install copulas\n"
