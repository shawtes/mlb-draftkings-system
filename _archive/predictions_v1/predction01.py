...
def process_predictions(chunk, pipeline, player_adjustments):
    ...
    chunk['predicted_dk_fpts'] = apply_smart_prediction_constraints(raw_predictions, chunk)
    ...
    # Final realistic range constraint (0 to 50 for typical MLB games, allowing outliers up to 60)
    chunk['predicted_dk_fpts'] = np.clip(chunk['predicted_dk_fpts'], 0, 60)
...
if __name__ == "__main__":
    ...
    model_file = 'c:/Users/smtes/OneDrive/Documents/draftkings project/MLB_DRAFTKINGS_SYSTEM/9_BACKUP/batters_final_ensemble_model_pipeline.pkl'
    prediction_date = '2025-07-07'  # Example prediction date, can be changed as needed
