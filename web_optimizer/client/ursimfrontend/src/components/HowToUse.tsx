        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-slate-400">Complete guide to mastering DFS and prop betting</p>
            </div>
          </div>
          ...
          <div className="relative mt-4">
            ...
            <Input
              ...
              className="pl-10 bg-black/60 border-cyan-500/20 text-white placeholder:text-slate-500"
            />
          </div>
        </div>

        {/* Tutorials */}
        <Card className="flex-1 overflow-hidden bg-black/60 backdrop-blur-sm border-cyan-500/20">
          <Tabs defaultValue="getting-started" className="h-full flex flex-col">
            <TabsList className="bg-gradient-to-r from-black via-cyan-950/10 to-black border-b border-cyan-500/20 justify-start overflow-x-auto">
                    ...
                    <Accordion type="multiple" className="space-y-3">
                      {tutorial.content.map((item, index) => (
                        <AccordionItem 
                          key={index} 
                          value={`item-${index}`}
                          className="bg-black/40 border border-cyan-500/10 rounded-lg px-4"
                        >
          ...
          <Card className="bg-cyan-500/5 border-cyan-500/20 p-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Start with small stakes while learning. Increase as you gain confidence.</p>
              </div>
            </div>
          </Card>
          <Card className="bg-blue-500/5 border-blue-500/20 p-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Never risk more than 5-10% of bankroll on a single slate.</p>
              </div>
            </div>
          </Card>
          <Card className="bg-purple-500/5 border-purple-500/20 p-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Keep detailed records of all bets and lineups to improve over time.</p>
              </div>
            </div>
          </Card>
        </div>
