...
2. Kill any existing processes on ports 5173/5000
3. Start backend server (port 5000)
4. Start frontend Vite app (port 5173)
...
class WebOptimizerLauncher:
    ...
    def kill_existing_processes(self):
        ...
        self.log("🔪 Killing existing processes on ports 5173 and 5000...")
        
        ports_to_check = [5173, 5000]
        killed_any = False
    ...
    def start_frontend_server(self):
        ...
        self.log("⚡ Starting frontend Vite server...")
        ...
        try:
            ...
            self.log("⏳ Waiting for Vite development server to start...")
            ...
            while time.time() - start_time < timeout:
                ...
                try:
                    ...
                    if result == 0:
                        self.log("✅ Frontend server started on port 5173", "#4CAF50")
                        return True
                ...
                time.sleep(2)
                self.log("⏳ Still waiting for Vite server...")
                self.root.update()
    ...
    def open_browser(self):
        ...
        time.sleep(2)  # Give Vite a moment to fully load
