...
start "🔧 UrSim Backend - Port 5000" cmd /k "cd /d "%~dp0..\..\server" && echo ════════════════════════════════════════ && echo 📡 BACKEND SERVER STARTING... && echo ════════════════════════════════════════ && echo. && "%NODE_PATH%\node.exe" index.js"
...
if not exist "node_modules" (
    ...
    echo.
    start "📦 Installing Dependencies" cmd /k "cd /d "%~dp0..\..\client" && echo Installing UrSim Frontend Dependencies... && echo This will take 5-10 minutes on first run... && echo. && "%NODE_PATH%\npm.cmd" install && echo. && echo ✅ Installation complete! && echo. && echo 🌐 Starting Vite dev server... && echo. && "%NODE_PATH%\npm.cmd" run dev"
) else (
    start "🌐 UrSim Frontend - Port 5173" cmd /k "cd /d "%~dp0..\..\client" && echo ════════════════════════════════════════ && echo 🌐 FRONTEND SERVER STARTING... && echo ════════════════════════════════════════ && echo. && "%NODE_PATH%\npm.cmd" run dev"
)
